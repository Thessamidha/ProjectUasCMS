                    ...
                    <div class="col-xxl-8">
                        @if (!is_null($content))
                            <div class="text-center my-5">
                                ...
                                <a class="text-gradient" href="https://www.instagram.com/thesaaa_aaa?igsh=MTJsamNodTk2dW85eA=="><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://www.facebook.com/tessa.stevani.7"><i class="bi bi-facebook"></i></a>
                                    <a class="text-gradient" href="https://www.tiktok.com/@tesaaa192?_t=8ngkTRqsqzA&_r=1"><i class="bi bi-tiktok"></i></a>
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                <span>Copyright &copy; <a href="https://www.instagram.com/thesaaa_aaa?igsh=MTJsamNodTk2dW85eA==" target="_blank">instagram</a> {{ now()->year }}</span>
                </div>
                <div class="col-auto">
